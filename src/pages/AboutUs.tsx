...
const AboutUs: React.FC = () => {
  ...
  const stars = (count: number) => {
    ...
    for (let i = 0; i < count; i++) {
      array.push(
        <svg key={i} className="star__icon">
      ...
      <div className="aboutUs__container">
        <div className="aboutUs__container--box">
          ...
          <p>
            ...
            que les apetezca, o crear nuevos grupos para realizar la actividad
            que elijan, en el día, lugar y hora que se indica en compañia de
            otros aventureros.
          </p>
          <p>
            Podrás hacerte amigo de otros usuarios de la aplicación. Y desde tu
            perfil verás los grupos a los que te has apuntado. Además, en
            función del tiempo de Madrid, te saldrán sugerencias de actividades.
          </p>
          <p>
